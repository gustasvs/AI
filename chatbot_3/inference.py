...
with open(f'{tokenizer_dir}/tokenizer.pickle', 'rb') as handle:
    tokenizer = pickle.load(handle)

with open(f"{tokenizer_dir}/START_TOKEN", "r") as f: 
    START_TOKEN = [int(f.read())] 
with open(f"{tokenizer_dir}/END_TOKEN", "r") as f: 
    END_TOKEN = [int(f.read())]
with open(f"{tokenizer_dir}/VOCAB_SIZE", "r") as f: 
...
checkpoint_path = f"{model_dir}/cp.ckpt"
